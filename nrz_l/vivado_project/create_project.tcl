# ==============================================================================
# Script TCL para recriar o projeto NRZ-L no Vivado
...
# Criar o projeto
create_project NRZ_L_Basys3 [file normalize "$origin_dir/vivado_project"] -part xc7a35tcpg236-1 -force
...
# nrz_l.vhd marcado como AutoDisabled (igual ao projeto original)
...
puts "======================================================================"
puts " Projeto NRZ_L_Basys3 criado com sucesso!"
puts ""
