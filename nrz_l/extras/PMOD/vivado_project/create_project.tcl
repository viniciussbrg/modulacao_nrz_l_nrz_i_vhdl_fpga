# ==============================================================================
# Script TCL para recriar o projeto NRZ-L com saida PMOD no Vivado
...
create_project NRZ_L_PMOD [file normalize "$origin_dir/vivado_project"] -part xc7a35tcpg236-1 -force
...
puts "======================================================================"
puts " Projeto NRZ_L_PMOD criado com sucesso!"
