----------------------------------------------------------------------------------
-- Testbench para Modulacao Digital por Inversao de Nivel
--
-- Clock:
...
architecture Behavioral of tb_nrz_i is
    ...
    constant INPUT_BITS : std_logic_vector(N_BITS - 1 downto 0) := "1011001110001111";
...
begin
    ...
    begin
        ...
        assert false report "Fim da simulacao NRZ-I" severity failure;
