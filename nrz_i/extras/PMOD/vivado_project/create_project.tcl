# ==============================================================================
# Script TCL para recriar o projeto NRZ-I com saida PMOD no Vivado
...
# Criar o projeto
create_project NRZ_I_PMOD [file normalize "$origin_dir/vivado_project"] -part xc7a35tcpg236-1 -force
...
puts "======================================================================"
puts " Projeto NRZ_I_PMOD criado com sucesso!"
puts ""
